            ...
            <nav className="container mx-auto h-auto flex justify-between items-center overflow-x-hidden overflow-y-visible">
                ...
                <ul className="flex flex-grow-[1] mx-0">
                    <li className={`list-item list-none mx-2 px-4 ${styles.actionMenu}`}>
                        ...
                        <div className={`fixed inset-0 bg-white mt-[100px] h-[calc(100vh-160px)] flex justify-center items-center transition-transform duration-100 ease-out transform ${activeSection === 'section1' ? styles.active : styles.hiddenSection}`}>
                                    ...
                                    <li role="menuitem" className='max-w-[25%] px-[1.25rem] list-none animate-fadeInUp' style={{ animationDelay: '0.050s' }}>
                                        <a href="/" title="TODOS LOS MODELOS" target="" className='p-3 min-h-14'>
                                            <div className='w-full'>
                                                <img className='max-w-[calc(80%)] m-auto' src="https://www.mitsubishi-motors.mx/content/dam/mitsubishi-motors-mx/images/homepage/hero-2024/MMCM_Modelos_Home_2024.png?width=720&auto=webp&quality=70" alt="full" />
                                            </div>
                    ...
                    <li className='list-item list-none mx-2 px-4'>
                        ...
                        <div className={`fixed inset-0 bg-white mt-[100px] h-[calc(100vh-160px)] flex justify-center items-center transition-transform duration-100 ease-out transform ${activeSection === 'section2' ? styles.active : styles.hiddenSection}`}>
                    ...
                    <li className='list-item list-none mx-2 px-4'>
                        ...
                        <div className={`fixed inset-0 bg-white mt-[100px] h-[calc(100vh-160px)] flex justify-center items-center transition-transform duration-100 ease-out transform ${activeSection === 'section3' ? styles.active : styles.hiddenSection}`}>
                            <div className="flex flex-row mx-auto p-4">
